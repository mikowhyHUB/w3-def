...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    """
    print((temperature * neutrons_produced_per_second), (threshold * 110)/100)
    if (temperature * neutrons_produced_per_second) < (threshold * 90)/100:
        return 'LOW'
    elif (temperature * neutrons_produced_per_second) >= (threshold * 90)/100 and (temperature * neutrons_produced_per_second) <= (threshold * 110)/100:
        return 'NORMAL'
    else:
        return 'DANGER'
